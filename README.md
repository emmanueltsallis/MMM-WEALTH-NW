...
A micro-meso-macro agent-based model combining Post-Keynesian, Kaleckian, and Neo-Schumpeterian frameworks to investigate inequality, wealth taxation, evasion, and capital flight in modern capitalist economies. Built on the [LSD](https://github.com/marcov64/Lsd) (Laboratory for Simulation Development) software.
