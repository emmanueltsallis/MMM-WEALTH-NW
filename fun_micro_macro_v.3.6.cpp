...
/*******************************************************************************
 * FEATURE TOGGLES (for incremental development)
 *
 * USE_HOUSEHOLD_DISAGGREGATION:
 *   0 = Original class-based behavior (3 aggregate classes A, B, C)
 *   1 = Individual household agents (N households) [FUTURE - Stage 2+]
 *
 * When toggle is 0: fun_households.h includes fun_classes.h (no change)
 * When toggle is 1: fun_households.h uses individual household equations
 ******************************************************************************/
#define USE_HOUSEHOLD_DISAGGREGATION 0
...
// NOTE: aclass, bclass, cclass pointers removed (Stage 5.5 CLASS removal)
