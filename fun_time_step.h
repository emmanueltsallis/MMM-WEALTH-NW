...
/*****GOVERNMENT*****/
V("Country_Unemployed_Households");                                // Stage 5.5: Needed for unemployment benefits
V("Country_Avg_Nominal_Wage");                                     // Stage 5.5: Needed for unemployment benefits
...
/*****CONSUMPTION DEMAND AND IMPORTS (Household-Driven)*****/
...
// NOTE: Class_Liquidity_Preference removed - now parameter-based
...
/*****ANALYSIS*****/
// NOTE: Class_Income_Share, Class_Wealth_Share removed (Stage 5.5)
// Inequality metrics now computed via household-level Gini calculations
V("P");                                                
V("U");                                               
V("G_n");                                              
V("Cri");                                              
